            ...
            <div className="prose prose-gray max-w-none space-y-8">
              <section>
                <p className="text-gray-700 leading-relaxed">
                  hobbyfind(이하 '회사'라 함)은 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-decimal list-inside mt-3 text-gray-700">
              ...
              <section>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <ul className="mt-2 text-gray-700 space-y-1">
                    <li>성명: 이가희</li>
                    <li>직책: 개발자</li>
                    <li>연락처: 01032220903, lijiaxi2319@gmail.com</li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  이 개인정보처리방침은 2025년 11월 5일부터 적용됩니다.
                </p>
              </section>
            </div>
          </div>
